...
<table class="tg">
  ...
  <tr>
    ...
    <li>Users who want to control budget.</li><li>Applications or computing jobs with steady-state usage.</li><li>Users who can commit to using TWCC over a longer time to reduce their total computing costs.</td>
  </tr>
  <tr>
...
<li>TWCC offers free 100 GB built-in disk space for VCS instances, and you can freely grow your storage with Virtual Disk Service, and flexibly attach additional volumes to instances. Also, we provide image service for instance image backup and recovery. See <a href="#Virtual-Disk-Service-VDS"><ins>Virtual Disk Service (VDS)</ins></a> for more pricing information.</li><li><a href="https://www.twcc.ai/intro/VM"><span style="font-weight:bold;color:rgb(255, 72, 67)"> See more</span></a></td>
  </tr>
  <tr>
