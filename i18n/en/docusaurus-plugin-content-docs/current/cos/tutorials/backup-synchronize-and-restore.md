...
<span class = "number">&#10102;</span> <b>Restore from backup</b>: All data backed up in COS will be restored to local machine, and the inconsistent data between both sides will still be stored in supercomputer.
...
- <b>Restore from backup</b>
    ...
    ```
- <b>Restore from synchronization</b>
    ```
