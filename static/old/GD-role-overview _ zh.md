...
[會員中心<i class="fa fa-question-circle fa-question-circle-for-service" aria-hidden="true"></i>](https://man.twcc.ai/@twsdocs/howto-service-access-service-zh) 為帳戶管理平台，[<ins>TWCC</ins>](https://www.twcc.ai/) 為提供運算資源服務平台，兩平台使用單一登入方式 (Single Sign On, SSO) 串接，用戶使用一個帳號即可登入兩種平台。

- 會員中心使用者區分為三種角色：**計畫建立者**、**計畫管理者**、**計畫成員** 
...
兩平台的使用者角色可互相對應，對應關係如下，其中會員中心的計畫建立者、計畫管理員兩種角色，在 TWCC 皆屬於租戶管理員： 
...
<i class="fa fa-arrow-circle-left" aria-hidden="true"></i> 會員中心、TWCC 各項服務的角色權限功能，請參考左側其他說明。
